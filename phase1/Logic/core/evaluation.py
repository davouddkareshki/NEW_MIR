...
if __name__ == '__main__':
    ...
    for method in methods : 
        ...
        print()
        predicted_1 = list(np.array(search_engine.search('fight club', method, weights, safe_ranking=True, max_results = 5))[:,0])
        predicted_2 = list(np.array(search_engine.search('kung fu', method, weights, safe_ranking=True, max_results = 5))[:,0])
        predicted_3 = list(np.array(search_engine.search('007', method, weights, safe_ranking=True, max_results = 5))[:,0])
        predicted_4 = list(np.array(search_engine.search('gotham', method, weights, safe_ranking=True, max_results = 5))[:,0])
       # print(search_engine.search('gotham', method, weights, safe_ranking=True, max_results = 5))
        #print(1/np.log2(5)) #khozabal
      #  print(predicted_4)
