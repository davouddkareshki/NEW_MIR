        ...
        for movie in corpus:
            ...
            if movie in self.root_set :
                for star in movie['stars'] :
                    ...
                    for movie_2 in corpus : 
                        if star in movie_2['stars'] :
                            base_set.add(movie_2['id'])
                            self.movie_nodes.add(movie_2['id'])

                            self.hubs[movie_2['id']] = 1
                            self.authorities[movie_2['id']] = 1

                            self.graph.add_node(movie_2['id'])
                            self.graph.add_edge(star,movie_2['id'])
                            self.graph.add_edge(movie_2['id'],star) 
