...
def get_summary_with_snippet(movie_info, query):
    ...
    #print('in UI data : ', summary)
    #print('in UI snippet : ', snippet)
    #print(summary)
    #print('-')
    #print(snippet)
    #print('-----')
        ...
        for i in range(len(snippet)):
          ...
          #  print(current_word) 
            if current_word.startswith("***") and current_word.endswith("***"):
                ...
                #print(current_word)
                #print(current_word_without_star)
               # star_words.append(current_word_without_star)
...
def main():
    ...
    st.markdown(
        '<span style="color:green">Developed By: Davood Kareshki</span>',
        unsafe_allow_html=True,
    )
